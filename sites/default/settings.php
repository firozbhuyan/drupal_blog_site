 ...
 * @endcode
 */
$settings['hash_salt'] = 'd0_XWSZXHnHBLcxNaPmOku_YyyBfEN50c3S11arZg0VNFcoKdtJmcOBt3zbeS08YDcVpgpbX4Q';
...
$settings['trusted_host_patterns'] = ['^drupal_blog\.com$'];
//$settings['trusted_host_patterns'] = ['^.+\drupal_blog\.comS']; //This is for production mode sub domain
...
$settings['config_sync_directory'] = 'sites/default/files/config_Tybhh6HzMWHNFMurwi-Sdn9kaaTc6UCWCnefMyFCmChBZkb2AYfaV5K8xMDSycm0OE-Mf6xcdw/sync';
